...
cat("  ✓ Spatial cutoff: 100 km (local/regional scale)\n")
...
SPATIAL_CUTOFF <- 100   # 100 km (local/regional scale)
...
fit_spatial_temporal_hawkes <- function(times, lons, lats, marks,
  ...
  upper_bounds <- c(mu = 100, beta_0 = 10, beta_violence = 10, beta_state = 10,
                   decay = 5, sigma = 100,
                   sigma_violent = 100,
                   sigma_peaceful = 100)[param_names]
...
# Save
write.csv(comparison_df, "model_comparison_phase3_fast_gaussian_100km.csv", row.names = FALSE)
cat("\n✓ Saved: model_comparison_phase3_fast_gaussian_100km.csv\n")
...
write.csv(hypothesis_tests, "hypothesis_tests_phase3_fast_gaussian_100km.csv", row.names = FALSE)
cat("\n✓ Saved: hypothesis_tests_phase3_fast_gaussian_100km.csv\n")
...
write.csv(spatial_params_df, "spatial_parameters_phase3_fast_gaussian_100km.csv", row.names = FALSE)
cat("\n✓ Saved: spatial_parameters_phase3_fast_gaussian_100km.csv\n")
...
saveRDS(results, "spatial_temporal_models_fast_gaussian_100km.rds")
cat("✓ Saved: spatial_temporal_models_fast_gaussian_100km.rds\n")
