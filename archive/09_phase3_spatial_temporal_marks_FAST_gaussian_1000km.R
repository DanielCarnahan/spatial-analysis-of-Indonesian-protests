...
# Save
write.csv(comparison_df, "model_comparison_phase3_fast_gaussian_1000km.csv", row.names = FALSE)
cat("\n✓ Saved: model_comparison_phase3_fast_gaussian_1000km.csv\n")
...
write.csv(hypothesis_tests, "hypothesis_tests_phase3_fast_gaussian_1000km.csv", row.names = FALSE)
cat("\n✓ Saved: hypothesis_tests_phase3_fast_gaussian_1000km.csv\n")
...
write.csv(spatial_params_df, "spatial_parameters_phase3_fast_gaussian_1000km.csv", row.names = FALSE)
cat("\n✓ Saved: spatial_parameters_phase3_fast_gaussian_1000km.csv\n")
...
saveRDS(results, "spatial_temporal_models_fast_gaussian_1000km.rds")
cat("✓ Saved: spatial_temporal_models_fast_gaussian_1000km.rds\n")
