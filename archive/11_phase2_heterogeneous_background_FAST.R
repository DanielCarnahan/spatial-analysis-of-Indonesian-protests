# Phase 2: Heterogeneous Background Rates - FAST VALIDATION DATASET
...
cat("╔═══════════════════════════════════════════════════════════════╗\n")
cat("║  PHASE 2: HETEROGENEOUS BACKGROUND RATES (FAST VALIDATION)  ║\n")
cat("╚═══════════════════════════════════════════════════════════════╝\n\n")
...
cat("  - Max 100 iterations\n")
cat("  - Expected time: 30-45 minutes\n")
cat("  - Validates heterogeneous μ implementation\n\n")
...
checkpoint_dir <- "checkpoints_phase2_heterogeneous_fast"
...
cat(sprintf("Using sample of %d events (%.1f%% of full dataset)\n",
            n_sample, 100*n_sample/nrow(protests)))
cat("NOTE: This is for validating heterogeneous background rate implementation\n")
...
fit_heterogeneous_hawkes <- function(times, marks, district_years, time_mat = NULL,
  ...
  # Optimize
  cat("  Starting optimization (max 100 iterations)...\n")
  cat(sprintf("  Expected time: 30-45 minutes\n"))
  ...
  fit <- optim(
    ...
    control = list(maxit = 100, factr = 1e10, trace = 1, REPORT = 10)
  )
...
het_fit <- fit_heterogeneous_hawkes(
  ...
  time_mat_sample,
  model_name = "Heterogeneous Background (Fast)",
  model_id = "HET_FAST"
)
...
# Save results
saveRDS(het_fit, "heterogeneous_hawkes_fast.rds")
cat("✓ Saved: heterogeneous_hawkes_fast.rds\n\n")
...
cat("╔═══════════════════════════════════════════════════════════════╗\n")
cat("║  PHASE 2 HETEROGENEOUS BACKGROUND COMPLETE (FAST VALIDATION) ║\n")
cat("╚═══════════════════════════════════════════════════════════════╝\n")
