# Phase 2: Mark-Dependent Temporal Hawkes Models - CHECKPOINT VERSION
...
cat("╔═══════════════════════════════════════════════════════════════╗\n")
cat("║    PHASE 2: MARK-DEPENDENT TEMPORAL HAWKES (CHECKPOINT)      ║\n")
cat("╚═══════════════════════════════════════════════════════════════╝\n\n")
...
cat("  6. checkpoints_phase2/ - Individual model checkpoints\n\n")
...
cat("  Run: unlink('checkpoints_phase2', recursive = TRUE)\n\n")
